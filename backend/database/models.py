...
class DecisionDocument(Base):
    """Association table for decisions and retrieved documents."""
    __tablename__ = "decision_documents"
    
    decision_id = Column(String(36), ForeignKey("decisions.id"), primary_key=True)
...
class Notification(Base):
    ...
    type = Column(String(50), nullable=False)  # email, slack, webhook
